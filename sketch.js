...
let messages = [
  ...
  "You have been assigned the number (). Please click one more time to have your photo taken."
];
...
function calculateAssignedNumber() {
  ...
  assignedNumber = floor(map(noiseValue, 0, 1, 1, 25));
  assignedNumber = constrain(assignedNumber, 1, 25);

  messages[6] = `You have been assigned the number (${assignedNumber}). Please click again to have your photo taken.`;
}
